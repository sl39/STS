...
// import React, { useState, useEffect } from "react";
// import { StyleSheet, FlatList, Image, View, Animated, Button } from 'react-native'
// import Slider from "react-slick";
// import "slick-carousel/slick/slick.css"; 
// import "slick-carousel/slick/slick-theme.css"; 
// import HorizonLine from "../../../src/utils/store/HorizontalLine";
...
//   return (
//     <View>
//       <div className="slider-container" style={{ width: '30%', margin: 'auto' }}>
//         <Slider {...settings}>
//           {imageUrls.map((url, index) => (
//             <div key={index}>
//               <img src={url} alt={`Slide ${index + 1}`} style={{ width: '100%', height: '200px', objectFit: 'cover' }} />
...
//       <div className="slider-container" style={{ width: '50%', margin: 'auto' }}>  나중에 이미지를 텍스트로
//         <Slider {...menuSettings}> 
//           {imageUrls.map((url, index) => (
//             <div key={index}>
//               <img src={url} alt={`Slide ${index + 1}`} style={{ width: '100%', height: '100px', objectFit: 'cover' }} />
//             </div>
//           ))}
//         </Slider>
//       </div>
//       </View>
//       <div>이거 components/store/Store.tsx로 처리가 되나? 모르겠네</div>
//       <HorizonLine/>
//       <div style={{display:"flex"}}>
//       {showResPer && <p>인원수</p>}
//       {showResPer && <button>-</button>}
//       {showResPer && <p>{RNoP}</p>}
//       {showResPer && <button>+</button>}
//       {showResPer && <button>확인</button>}
//       </div>
//       <a href="tel:02-1234-1234">전화(전화번호도 받아와야 함)</a> 
//       <button onClick={handleResPerClick}>{showResPer ? '예약 인원 설정 풀기' : '예약 인원 설정'}</button> 
//       <div className="outer">
//        <button className ="fab" onClick={handleEnter}>장바구니 가기</button>
//       </div>
//       <button onClick={listEnter}>내 정보창 가기</button>
//       <button onClick={OptionEnter}>옵션창 가기</button>
//     </View>
...
// import { ImageSlider, TouchableView } from '../../../src/components/store'; // ImageSlider 컴포넌트 경로에 맞게 수정
// import { useRoute } from '@react-navigation/native'; // storeid를 사용할 경우 경로를 통해 가져오는 경우

// const { width } = Dimensions.get('window'); // 화면의 너비 가져오기

// const StoreSliderScreen: React.FC = () => {
//   const route = useRoute();
//   // const { storeid } = route.params; // storeid를 경로에서 받아오는 경우

//   // 슬라이드에 표시할 이미지 URL 리스트
//   const imageUrls = [
//     'https://cdn.pixabay.com/photo/2017/09/13/03/55/cosmos-2744329_1280.jpg',
//     'https://blog.kakaocdn.net/dn/d1e6IL/btr41J8GWEF/YyPzwHfiDY5jOyAZWr6G7K/img.jpg',
//     'https://cdn.pixabay.com/photo/2017/09/13/03/55/cosmos-2744329_1280.jpg'
//     // `https://example.com/store/${storeid}/image1.jpg`,
//     // `https://example.com/store/${storeid}/image2.jpg`,
//     // `https://example.com/store/${storeid}/image3.jpg`,
//   ];

//   return (
//     <SafeAreaView style={styles.container}>
//       <ImageSlider
//         imageUrls={imageUrls}   // 이미지 배열
//         imageWidth={width}      // 화면의 너비에 맞춰 슬라이드
//         imageHeight={200}       // 이미지 높이 설정
//         showThumbnails={true}   // 썸네일 표시 여부
//         autoSlideInterval={4000} // 자동 슬라이드 간격 4초 설정
//       />
//     </SafeAreaView>
//   );
// };
...
// export default StoreSliderScreen;


// import React from 'react'
// import { SafeAreaView, Dimensions } from 'react-native'
// import { ImageSlider } from '../../../src/components/store' // ImageSlider 컴포넌트 가져오기
...
//   return (
//     <SafeAreaView style={{ flex: 1 }}>a
//       <ImageSlider
//         imageUrls={imageUrls}
//         imageWidth={width}  // 화면의 너비에 맞춰 이미지 슬라이드 설정
//         imageHeight={height}
//         showThumbnails={false}  // 썸네일 표시
//         autoSlideInterval={1000}  // 자동 슬라이드 간격 (1초)
//       />
//     </SafeAreaView>
//   )
// }
...
// import { SafeAreaView, TextInput, Button, View, Text, Dimensions } from 'react-native'
// import { ImageSlider, TouchableView } from '../../../src/components/store'
...
//         imageUrls={imageUrls}
//         imageWidth={width}
//         showThumbnails={false} // 썸네일 표시 안함
//       />
//     </SafeAreaView>
//   )
// }
...
// // 왜 여기서 hook 사용하지 말라고 하는거지? 정확히는 훅 포함되면 아래처럼 나옴
...
// // const imageUrlss = useMemo ( () => new Array (
// //   'https://via.placeholder.com/300/FF0000/FFFFFF?text=Image+1',
// //   'https://via.placeholder.com/300/00FF00/FFFFFF?text=Image+2',
// //   'https://via.placeholder.com/300/0000FF/FFFFFF?text=Image+3',
// //   'https://via.placeholder.com/300/FFFF00/FFFFFF?text=Image+4',
...
//       <ImageSlider imageUrls={imageUrlss} imageWidth={300} />
//     </View>
//   );
// };
...
// import { View, StyleSheet } from 'react-native';
// import { ImageSlider } from '../../../src/components/store'; // ImageSlider 컴포넌트 경로에 맞게 수정
// import {useToggle, useLayout} from '../../../src/hooks'
