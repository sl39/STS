...
export const MenuCategory = () => {
    ...
    const handleAddCategory = () => {
        const isCategoryExists = categoryList.some((element) => element.subject === categoryName);
        ...
        const categoryTest = { category_pk: cnt, subject: categoryName };
        setCnt((c) => c + 1);
        setCategoryList([...categoryList, categoryTest]);
                ...
                <View style={{ padding: 10 }}>
                    <View style={{ width: 200, alignItems: 'flex-end' }}>
                        <View style={{ width: 120 }}>
                            <Button title="메뉴 그룹 추가" onPress={() => setShowInput(!showInput)} />
                        </View>
                    </View>
                    {showInput && (
                        <View style={styles.inputContainer}>
                            ...
                            <View style={styles.buttons}>
                                ...
                                <Pressable style={[styles.button, styles.buttonAdd]} onPress={handleAddCategory}>
...
const renderItem = (item: categoryType, deleteMenuGroup: (pk: number) => void) => (
    <View style={{ backgroundColor: 'white', margin: 10, padding: 10 }}>
        <View>
            <Menu subject={item.subject} category_pk={item.category_pk} deleteMenuGroup={deleteMenuGroup} />
        </View>
    </View>
);
